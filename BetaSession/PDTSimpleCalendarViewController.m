...
- (void)viewDidLoad
{
    ...
    [[PDTSimpleCalendarViewCell appearance] setCircleDefaultColor:[UIColor blackColor]];
    [[PDTSimpleCalendarViewCell appearance] setCircleSelectedColor:[UIColor blueColor]];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    BBChooseTableViewController *tvc = [[BBChooseTableViewController alloc] init];
    
    tvc.dateChosen = self.selectedDate;
